...
const About = () => (
    ...
    <section className="about">
      <h2 className="about__title">About 5 Calls</h2>

      <h3 className="about__subtitle">Why Calling Works</h3>
      ...
      <ul>
      <li><a href="https://www.nytimes.com/2016/11/22/us/politics/heres-why-you-should-call-not-email-your-legislators.html">“Here’s Why You Should Call, Not Email, Your Legislators”</a> <span className="about__source">NY Times</span></li>
      <li><a href="http://www.vox.com/policy-and-politics/2016/11/15/13641920/trump-resist-congress">“Don’t just write to your representatives. Call them — and go to town halls.”</a> <span className="about__source">Vox</span></li>
      <li><a href="https://www.washingtonpost.com/powerpost/a-day-of-chaos-at-the-capitol-as-house-republicans-back-down-on-ethics-changes/2017/01/03/50e392ac-d1e6-11e6-9cb0-54ab630851e8_story.html?utm_term=.86c8d3a06832">“I can tell you the calls we’ve gotten in my district office and here in Washington surprised me, meaning the numbers of calls.”</a> <span className="about__source"> Washington Post</span></li>
      <li><a href="https://twitter.com/costareports/status/816373917900161024">“Most members tell me blizzard of angry constituent calls were most impt factor in getting the House to sideline the amdt”</a> <span className="about__source">Robert Costa</span></li>
      </ul>
      ...
      <h3 className="about__subtitle">Calling Tips</h3>
      ...
      <h3 className="about__subtitle">Who made 5 Calls?</h3>
      <p>5 Calls is a volunteer effort. Founded and run by husband and wife team <a href="https://twitter.com/nickoneill">Nick</a> and <a href="https://twitter.com/syntheticmethod">Rebecca</a>, many dedicated volunteers contribute design, code and issues to the site including: <a href="https://twitter.com/monteiro">@monteiro</a>, <a href="https://twitter.com/stewartsc">@stewartsc</a>, <a href="https://twitter.com/liamdanger">@liamdanger</a>, <a href="https://twitter.com/capndesign">@capndesign</a>, <a href="https://twitter.com/jameshome">@jameshome</a>, <a href="https://twitter.com/beau">@beau</a>, <a href="https://twitter.com/cdoremus">@cdoremus</a>, <a href="https://twitter.com/ocderby">@ocderby</a>, <a href="https://twitter.com/mr0grog">@mr0grog</a> and <a href="https://github.com/5calls/5calls/graphs/contributors">more supporters.</a></p>
      ...
      <h3 className="about__subtitle">Join us</h3>
